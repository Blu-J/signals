...
describe("With Signal", function() {
  ...
  describe("with onValue", function() {
    ...
    it("should be able to get two signals at a time", function() {
      ...
      onValue1 = sig =>
        Signal.onValue(function(newValue) {
  ...
  describe("constructors", function() {
    ...
    describe("from function", function() {
      ...
      it("should returns signal", function() {
        return expect(
          Signal.isSignal(Signal.fromFunction(function(resolve) {}))
        ).to.be["true"];
      });
      ...
      it("should return in order the values sunk", function() {});
    });
    describe("from promises", function() {
      ...
      it("should return a signal", function() {
        expect(Signal.isSignal(Signal.fromPromises())).to.be["true"];
      });
    });
  });
  describe("with foldp", function() {
    ...
    it("then lazy should work as a fold, for example sum", function() {
      ...
      peer = sig =>
        Signal.onValue(function(currentValue) {
  ...
  describe("with flatten mapping", function() {
    ...
    it("should be able to create a combinatorics", function() {
      ...
      return expect(lastSeen).to.deep.equal([
        ["a", "1"],
        ["a", "2"],
        ["b", "1"],
        ["b", "2"]
